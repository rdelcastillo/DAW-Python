"""
Cajero de cambio: devuelve y desglosa el cambio en billetes y monedas de forma "ideal"; es decir, con el menor número de
billetes y monedas posibles.

Pide un valor en euros y devuelve los billetes de 500, 200, 100, 50, 20, 10 y 5 euros, y las monedas de 2€, 1€, 50c,
20c, 10c, 5c, 2c y 1c. Ejemplo:
...
# Dividir entre euros y céntimos
