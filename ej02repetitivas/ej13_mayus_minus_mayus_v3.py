...
Usaremos la claúsula "continue" del for.
...
for c in user_string:
    ...
    if index_c < len(UPPERCASE_LETTERS):  # c está en las mayúsculas
        ...
        continue  # voy a la siguiente iteración del for
    ...
    final_string += UPPERCASE_LETTERS[index_c] if index_c < len(LOWERCASE_LETTERS) else c
