...
from movement import Deposit, Withdraw, InitialBalance, TransferIssued, TransferReceived
...
class BankAccount:
    ...
    def __init__(self, balance: float = 0):
        ...
        self.__movements = [InitialBalance(balance)] if balance > 0 else []
    ...
    def deposit(self, money: float):
        ...
        self.__movements.append(Deposit(money))
    ...
    def withdraw(self, money: float):
        ...
        self.__movements.append(Withdraw(money))
    ...
    def transfer(self, other: 'BankAccount', money: float):
        ...
        self.__movements.append(TransferIssued(money, other.__number))
        other.__movements.append(TransferReceived(money, self.__number))
